        ...
        <form action="BuyServlet" method="POST">
            <table>
                ...
                <%
                    ...
                    String td = "<td>";
                    String tdd = "</td>";
                    String buyButt = "<input type=submit name></input>";
                    String dat;
                    if (category == null || category.equals("all")) {

                        for (Product pdt : pdtList) {
                            dat = tr + td + pdt.getProduct_ID() + tdd + td + pdt.getName() + tdd + td + pdt.getDescription() + tdd + td + pdt.getCategory()
                                    + tdd + td + pdt.getPrice() + tdd + td + "<Button type='submit' name='Buy" + pdt.getName() + "Button' value='" + pdt.getProduct_ID() + "'>Buy</button>" + tdd + trr;
                %>
                <%= dat%>
                <%
                    }
